    ...
    <div style={{width:'100%',minHeight:'100vh'}} className='d-flex justify-content-center align-item-center bg-dark'>
      <div style={{width:'600px'}} className='bg-light rounded p-5'>
        ...
        <form className='mt-5'>
          ...
          <TextField value={rate||""} name='rate' className='w-100' id="outlined-rate" label="Rate of Interest" variant="outlined" />
          </div>
          {/* invalid Priciple */}
          ...
          <TextField value={year||""} name='year' className='w-100' id="outlined-year" label="Time period(Yr)" variant="outlined" />
          </div>
          {/* invalid Priciple */}
          ...
          <Button onClick={handleReset}  style={{width:'50%',height:'70px'}} className='border border-dark text-dark ' varient='outlinened'>Reset</Button>
